...
<action>Explain to {user_name} the epic discovery process using natural
dialogue</action>
...
<action>Extract epic numbers from story filenames (pattern:
...
from {story_directory}/{{epic_number}}-{{story_num}}-\*.md</action>
...
{retrospectives_folder}/epic-{{epic_number}}-retro-{date}.md</action>
...
- Retrospective saved:
  {retrospectives_folder}/epic-{{epic_number}}-retro-{date}.md
