...
- The `{project-root}/_bmad/core/tasks/validate-workflow.xml` framework will
  automatically:
...
- **Workflow variables**: From workflow.yaml (story_dir, output_folder,
  epics_file, etc.)
...
3. **Load validation framework**:
   `{project-root}/_bmad/core/tasks/validate-workflow.xml`
4. **Extract metadata**: epic_num, story_num, story_key, story_title from story
   file
5. **Resolve all workflow variables**: story_dir, output_folder, epics_file,
