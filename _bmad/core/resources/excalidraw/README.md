...
Universal knowledge for creating Excalidraw diagrams. All agents that create
Excalidraw files should reference these resources.

## Purpose

Provides the **HOW** (universal knowledge) while agents provide the **WHAT**
...
- Presentation Master (CIS): Pitch decks, creative visuals, Rube Goldberg
  machines
...
1. **External Library Loader** - Load .excalidrawlib files from
