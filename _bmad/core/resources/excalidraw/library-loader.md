...
Load external .excalidrawlib files from <https://libraries.excalidraw.com> or
custom sources.
...
This will be developed when agents need to leverage the extensive library
ecosystem available at <https://libraries.excalidraw.com>.
...
Future: Users will be able to configure favorite libraries in their BMAD config
